classdef parfor_wait < handle
   ...
   methods (Access = private)
       ...
       function WaitbarUpdate(Obj)
           ...
           waitbar(Obj.NumMessage/Obj.TotalMessage, Obj.WaitbarHandle, [num2str(Obj.NumMessage/Obj.TotalMessage*100, '%.0f'), '%; ', num2str(UsedTime_now/60, '%.2f'), 'min used and ', num2str(EstimatedTimeNeeded/60, '%.2f'), 'min needed.']);
